...
class Exploration:
    ...
    def find_maximum_pressure(self, time_limit):
        ...
        while queue:
            ...
            if current_state.time == time_limit or current_state in attempted_configurations or len(current_state.opened_valves) == len(valves_worth_opening) or (time_limit - current_state.time <= time_limit // 3 and current_state.pressure < max_pressure // 3):
                continue
            else:
